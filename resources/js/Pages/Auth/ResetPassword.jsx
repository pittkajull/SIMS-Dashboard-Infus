    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-8 text-center">
                ...
                <h3 className="text-2xl font-black tracking-tight text-slate-800">Buat Password Baru</h3>
                <p className="text-slate-500 text-sm mt-1.5 font-medium">Amankan akun medis Anda</p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-5">
                <div className="group">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-5 py-4 pl-12 text-sm font-bold text-slate-800 focus:bg-white focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100 outline-none transition-all shadow-sm"
                            required
                        />
                ...
                <div className="group">
                    <label className="text-[10px] font-bold text-slate-500 uppercase block mb-2 ml-1 tracking-widest">Password Baru</label>
                    <div className="relative">
                        <input
                            type="password"
                            value={data.password}
